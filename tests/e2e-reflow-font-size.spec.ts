...
test("increasing source paragraph font size moves downstream paragraphs", async ({ page }) => {
  const samplePath = path.resolve("tmp/core-reflow-font-size.pdf");
  ...
  await page.locator("#fontSize").fill("34");
